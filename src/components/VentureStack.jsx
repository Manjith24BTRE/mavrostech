      ...
      <div className="venture-stack" id="venture-stack" ref={stackRef}>
        ...
        <div className="v-card v-card-2" style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', overflowX: 'hidden', paddingBottom: '16px', marginBottom: '8px', opacity: 0.8 }}>
            <img loading="lazy" src="https://images.unsplash.com/photo-1554118811-1e0d58224f24?auto=format&fit=crop&q=80&w=200" alt="Cafe and Restaurant Premium Web Design - Mavros Tech" style={{ width: '80px', height: '80px', objectFit: 'cover', borderRadius: '12px' }} />
            <img loading="lazy" src="https://images.unsplash.com/photo-1519167758481-83f550bb49b3?auto=format&fit=crop&q=80&w=200" alt="Luxury Banquet Hall Booking Website Concept - Mavros Tech" style={{ width: '80px', height: '80px', objectFit: 'cover', borderRadius: '12px' }} />
            <img loading="lazy" src="https://images.unsplash.com/photo-1608248597279-f99d160bfcbc?auto=format&fit=crop&q=80&w=200" alt="Premium Skincare & Beauty Clinic Website Concept - Mavros Tech" style={{ width: '80px', height: '80px', objectFit: 'cover', borderRadius: '12px' }} />
          </div>
